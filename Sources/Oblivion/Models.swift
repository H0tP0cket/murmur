...
enum Prompts {
    ...
    static let personalContext = "Using what you know about me from our conversations and anything I provide, write a concise first-person reference for Oblivion, my AI meeting copilot. Cover my background, roles, technical and business skills, strongest projects and accomplishments, current goals, and concrete stories useful in interviews, sales calls, and business meetings. Include my specific contributions and confirmed results or metrics. Use factual details to make me sound credible and impressive. Do not invent anything. Ask about important gaps before writing. Use clear headings and short paragraphs without em dashes or colons."
