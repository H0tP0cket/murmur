...
## Native application recommendation

Use SwiftUI for the main chat and AppKit where precise window, focus, and floating-panel behavior is required. Use native audio capture and a local persistence layer. This is an architectural recommendation for this one-Mac application, not a claim that framework memory use has been benchmarked.
...
## GPT-Live-1: secondary integration
